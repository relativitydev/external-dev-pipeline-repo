...
[How to use Azure Pipelines](#how-to-use-azure-pipelines)
[Create Your Pipeline](#create-your-pipeline)
[Customize Azure Pipelines to be a Relativity Rap File CI/CD](#customize-azure-pipelines-to-be-a-relativity-rap-file-cicd)
- [New Variable Group](#new-variable-group)
- [New Azure Key Vault Group](#new-azure-key-vault-variable-group)
- [Initial azure-pipelines.yml Setup](#initial-azure-pipelinesyml-setup)
- [Restore Nuget Packages](#restore-nuget-packages-task-name-nuget)
- [Build Solution](#build-solution-task-name-visual-studio-build)
- [Run Unit Tests](#run-unit-tests-task-name-visual-studio-test)
- [Run Integration Tests](#run-integration-tests-task-name-visual-studio-test)
- [Build Rap File](#build-rap-file-task-name-command-line)
- [Push Rap File to Artifacts](#push-rap-file-to-artifacts-task-name-publish-build-artifacts)
- [Create a Release Pipeline to push the Rap File to the Solution Snapshot Website](#create-a-release-pipeline-to-push-the-rap-file-to-the-solution-snapshot-website)
  - [Build Pipeline Chanages](#build-pipeline-changes-copy-and-publish-upload-script-and-solutionsnapshotsalesforceloginhelperdll)
  - [Create Release Pipeline](#create-release-pipeline)
- [Setting up Github to require builds to pass on Pull Requests](#setting-up-github-to-require-builds-to-pass-on-pull-requests)
- [Slack Notifications for Azure Pipelines](#slack-notifications-for-azure-pipelines)
